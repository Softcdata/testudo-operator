...
type BackupPolicyInformer interface {
	...
	Lister() disasterv1.BackupPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.DisasterV1().BackupPolicies(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DisasterV1().BackupPolicies(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DisasterV1().BackupPolicies(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DisasterV1().BackupPolicies(namespace).Watch(ctx, options)
			},
		},
		&apisdisasterv1.BackupPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backupPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdisasterv1.BackupPolicy{}, f.defaultInformer)
}

func (f *backupPolicyInformer) Lister() disasterv1.BackupPolicyLister {
	return disasterv1.NewBackupPolicyLister(f.Informer().GetIndexer())
}
